...
.method public constructor <init>(Lcom/rookery/translate/AITranslator;Ljava/lang/String;JLandroid/content/Context;Lcom/tencent/mobileqq/activity/aio/item/TextTranslationItemBuilder$Holder;Ljava/lang/String;Lcom/rookery/translate/type/Language;Lcom/rookery/translate/type/TranslateCallback;Ljava/util/List;Ljava/util/List;ILcom/rookery/translate/AITranslator$TranslatorType;)V
    ...
    .prologue
    .line 177
    iput-object p1, p0, Ldsd;->a:Lcom/rookery/translate/AITranslator;

    iput-object p2, p0, Ldsd;->a:Ljava/lang/String;

    iput-wide p3, p0, Ldsd;->a:J

    iput-object p5, p0, Ldsd;->a:Landroid/content/Context;

    iput-object p6, p0, Ldsd;->a:Lcom/tencent/mobileqq/activity/aio/item/TextTranslationItemBuilder$Holder;

    iput-object p7, p0, Ldsd;->b:Ljava/lang/String;

    iput-object p8, p0, Ldsd;->a:Lcom/rookery/translate/type/Language;

    iput-object p9, p0, Ldsd;->a:Lcom/rookery/translate/type/TranslateCallback;

    iput-object p10, p0, Ldsd;->a:Ljava/util/List;

    iput-object p11, p0, Ldsd;->b:Ljava/util/List;

    iput p12, p0, Ldsd;->a:I

    iput-object p13, p0, Ldsd;->a:Lcom/rookery/translate/AITranslator$TranslatorType;
...
.method public a(Lcom/rookery/translate/type/TranslateError;Ljava/lang/Long;)V
    ...
    iget-wide v1, p0, Ldsd;->a:J

    iget-object v3, p0, Ldsd;->a:Landroid/content/Context;

    iget-object v4, p0, Ldsd;->a:Lcom/tencent/mobileqq/activity/aio/item/TextTranslationItemBuilder$Holder;

    iget-object v5, p0, Ldsd;->b:Ljava/lang/String;

    iget-object v6, p0, Ldsd;->a:Ljava/util/List;

    iget-object v7, p0, Ldsd;->b:Ljava/util/List;

    iget-object v8, p0, Ldsd;->a:Lcom/rookery/translate/type/Language;

    iget-object v9, p0, Ldsd;->a:Lcom/rookery/translate/type/TranslateCallback;

    iget v10, p0, Ldsd;->a:I

    iget-object v11, p0, Ldsd;->a:Lcom/rookery/translate/AITranslator$TranslatorType;
...
.method public a(Ljava/util/List;Ljava/util/List;Ljava/lang/Long;)V
    ...
    iget-object v6, p0, Ldsd;->a:Lcom/rookery/translate/type/Language;

    iget-object v7, p0, Ldsd;->a:Lcom/rookery/translate/type/TranslateCallback;

    const/4 v8, 0x0

    sget-object v9, Lcom/rookery/translate/AITranslator$TranslatorType;->GOOGLE:Lcom/rookery/translate/AITranslator$TranslatorType;

    iget-object v12, p0, Ldsd;->a:Ljava/util/List;
